...
if "p1" not in form:
    ...
    print('<script src="/scripts/sequence_seekerV4.js"></script>')
    print('<title>SSE v.4</title>')
    print('</head>')
    print('<body>')
    print('<form action="javascript:sendform()" method="post" id="sequence_seeker_form" name="collect_data_form" >')
    print('<div id="p_value">SSE v.4&nbsp;&nbsp;|&nbsp;&nbsp;P1=&nbsp;<input type="text" name="p1" value="" />')
    print('&nbsp;&nbsp;P1 range&nbsp;(<input type="text" name="kp1" value="" />)')
    ...
    calc = SequenceSeekerV4(p1, kp1, kp2, kp3)
