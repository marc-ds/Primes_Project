...
if "p1" not in form:
    ...
    print('<script src="sequence_seekerV6.js"></script>')
    print('<title>Sequence Seeker V6</title>')
    print('</head>')
    print('<body>')

    print('<form action="javascript:sendform()" method="post" id="sequence_seeker_form" name="collect_data_form" >')

    print('<div id="abc">P1=&nbsp;<input type="text" name="p1" value="" />&nbsp;&nbsp;'
          'P1 range=&nbsp;<input type="text" name="kp1" value="" />&nbsp;&nbsp;'
          'P2 range=&nbsp;<input type="text" name="kp2" value="" />&nbsp;&nbsp;'
          'P3 range=&nbsp;<input type="text" name="kp3" value="" />&nbsp;&nbsp;'
    ...
    """print('<form action="javascript:sendform()" method="post" id="sequence_seeker_form">')
    ...
    calc = SequenceSeekerV6(p1, kp1, kp2, kp3)
