...
if "p1" not in form:
    ...
    print('<script src="/scripts/sequence_seekerV6.js"></script>')
    print('<title>SSE v.6</title>')
    print('</head>')
    print('<body>')

    print('<form action="javascript:sendform()" method="post" id="sequence_seeker_form" name="collect_data_form" >')

    print('<div id="abc">SSE v.6&nbsp;&nbsp;|&nbsp;&nbsp;'
          'P1=&nbsp;<input type="text" name="p1" value="" />&nbsp;&nbsp;'
          'P1&nbsp;(<input type="text" name="kp1" value="" />)&nbsp;&nbsp;'
    ...
    print('<span id="nextp1">The next P1 is {}</span>'.format(sp.nextprime(p1, kp1)))
