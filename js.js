...
function sendform() {
    ...
    xhr.open("POST", "/cgi-bin/sequenceSeekerV2_view.py");
...
function sendformv3() {
    var formElement = document.querySelector("form");
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "/cgi-bin/sequenceSeekerV3_view.py");
    xhr.timeout = 4294967295;
...
function sendformv3a() {
    var formElement = document.querySelector("form");
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "/cgi-bin/sequenceSeekerV3a_view.py");
    xhr.timeout = 4294967295;
...
function sendformv4() {
    var formElement = document.querySelector("form");
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "/cgi-bin/sequenceSeekerV4_view.py");
    xhr.timeout = 4294967295;
